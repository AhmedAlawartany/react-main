...
import type { ElementType, ComponentPropsWithRef, ReactNode, CSSProperties } from 'react';
...
const Container = forwardRef((props: ContainerProps, ref) => {
    const { children, asElement: Component = 'div', ...rest } = props;

    return (
        <Component ref={ref} className={'container mx-auto'} {...rest}>
            {children}
        </Component>
    );
});
